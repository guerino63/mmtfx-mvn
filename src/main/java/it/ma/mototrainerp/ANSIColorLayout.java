...
public class ANSIColorLayout extends PatternLayout {
    private static final String ANSI_BLACK = "\u001B[1;30m";
    ...
    private static final String ANSI_PURPLE = "\u001B[1;35m";
    private static final String ANSI_CYAN = "\u001B[1;36m";
    private static final String ANSI_WHITE = "\u001B[1;37m";

    private static final String DEFAULT_COLOR_ALL = ANSI_WHITE;
    private static final String DEFAULT_COLOR_FATAL = ANSI_RED;
    private static final String DEFAULT_COLOR_ERROR = ANSI_RED;
    private static final String DEFAULT_COLOR_WARN = ANSI_YELLOW;
    private static final String DEFAULT_COLOR_INFO = ANSI_BLUE;
    private static final String DEFAULT_COLOR_DEBUG = ANSI_PURPLE;
    //public static final String DEFAULT_COLOR_RESET = "\u001B[1;37m";
    private static final String DEFAULT_COLOR_STACKTRACE = ANSI_CYAN;
    private static final String DEFAULT_COLOR = ANSI_BLACK;
