...
public class ArduinoData {
    private final static Log LOGGER = LogFactory.getLog(ArduinoData.class);

    private static final SimpleIntegerProperty ACCELERATORE = new SimpleIntegerProperty(1);
    static public final SimpleIntegerProperty ACCELERATORE_MIN = new SimpleIntegerProperty(Prop.Desc.ACCELERATORE_MIN.getValueInt());
    static public final SimpleIntegerProperty ACCELERATORE_MAX = new SimpleIntegerProperty(Prop.Desc.ACCELERATORE_MAX.getValueInt());
    ...
    static public final SimpleIntegerProperty FRENO_POST_MIN = new SimpleIntegerProperty(Prop.Desc.FRENO_POSTERIORE_MIN.getValueInt());
    static public final SimpleIntegerProperty FRENO_POST_MAX = new SimpleIntegerProperty(Prop.Desc.FRENO_POSTERIORE_MAX.getValueInt());
    ...
    static public final SimpleIntegerProperty FRENO_ANT_MIN = new SimpleIntegerProperty(Prop.Desc.FRENO_ANTERIORE_MIN.getValueInt());
    static public final SimpleIntegerProperty FRENO_ANT_MAX = new SimpleIntegerProperty(Prop.Desc.FRENO_ANTERIORE_MAX.getValueInt());
    ...
    private static final SimpleBooleanProperty MARCIA_DEC = new SimpleBooleanProperty();
 ...
 F7 -> Fine messaggio
    ...
    public void setData(byte[] buf) {
        LOGGER.debug(Hex.encodeHexString( buf ));
