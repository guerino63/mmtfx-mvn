...
class VideoProcessing {
    ...
    Duration duration;
    static final TimeLineMsecs timeLine = new TimeLineMsecs();
    static final TimeLineLuigi timeLineLuigi = new TimeLineLuigi();
    static final ServerLuigi serverLuigi = new ServerLuigi();
